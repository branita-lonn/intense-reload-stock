...
import { BranchApprovalSettingsCard } from "@/components/dashboard/branch-approval-settings-card";
...
export default async function BranchDetailPage({
  ...
  // Fetch store settings to determine global requireSaleApproval default value
  const storeSettings = await prisma.storeSettings.findFirst({
    select: { requireSaleApproval: true },
  });
  const globalRequireApproval = storeSettings?.requireSaleApproval ?? true;
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="lg:col-span-1 space-y-6">
          <Card className="rounded-3xl border bg-card shadow-sm flex flex-col justify-between overflow-hidden">
            <div>
          ...
          <BranchApprovalSettingsCard
            branchId={branch.id}
            initialOverride={branch.requireSaleApprovalOverride}
