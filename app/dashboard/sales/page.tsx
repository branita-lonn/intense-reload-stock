...
// Page component for querying sales transaction logs.
...
import { SalesHistoryClient } from "@/components/dashboard/sales-history-client";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Sales History | Intense Reload",
  description: "View and filter log counter sales history.",
};
